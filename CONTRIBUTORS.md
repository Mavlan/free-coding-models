...
Thank you to everyone who has improved `free-coding-models`!
...
- 📁 **Muhammad95959**: `--config-dir` flag and XDG support
- ⭐ **FaintFlower**: Star History chart mirror fix
- 🚀 **lehneres**: Proxmox VE installation scripts
- 🌩️ **ia-S-on**: Cloudflare `{account_id}` env resolution in launch paths
- 🐬 **bangla24bdrang-lab**: OrcaRouter provider integration
- 💘 **skylaweber**: Crush integration
- 🧠 **serajbaltu**, **chindris-mihai-alexandru**, **erwinh22**, **PhucTruong-ctrl**, **stgreenb**, **MoriDanWork**: provider additions, fixes and reports

## Maintainer

Created and maintained by [Vanessa Depraute](https://vanessadepraute.dev) ([@vava-nessa](https://github.com/vava-nessa)).

Want to be listed here? Open a PR: issues, fixes, and new provider integrations are all welcome. See [Contributing](./README.md#contributing) in the README and the [development guide](./docs/development.md).
